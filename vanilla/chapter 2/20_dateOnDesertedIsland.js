...
// 5) Now expand monthName() to create monthToDays(monthNum), returning the number of days in that month, in the year 2017. Hint:
// use a SWITCH statement for the days in each month.
